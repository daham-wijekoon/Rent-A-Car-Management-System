...
<body >
  ...
  <form class="my-form" action="php/driv.php" method="POST">
      <div>
        <h2>Registration</h2>
      </div>
        <div class="form">
          ...
          <div class ="emp-tp">
              <p>Tel.No:</p>
              <input type="tel" name="e_tel" placeholder= "Enter Employee's Tel.no.">
          </div>
           <div class ="emp-name">
              <p>Name:</p>
           ...
           <div class ="liense-no">
              <p>License No.:</p>
              <input type="text" name="license_no" placeholder= "Enter the License No.">
          </div>
           <div class ="emp-DOB">
              <p>Date Of Birth:</p>
          ...
          <div class ="emp-nic">
              <p>Driver NIC:</p>
              <input type="text" name="e_nic" placeholder= "Enter Employee's NIC">
          </div>
           <div class ="view" action="views/driv_view.php'">
              <input type ="button" name="view" value="View" onclick="window.location='views/driv_view.php'">
          </div>
          <div class ="submit">
