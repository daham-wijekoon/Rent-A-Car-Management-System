...
<body >
  ...
  <div class="p-box"></div>
    <form class="my-form" action="php/cus.php" method="POST">
      <div>
        <h2>Registration</h2>
      </div>
        <div class="form">
          ...
          <div class ="cus-add">
              <p>Address:</p>
              <input type="text" name="c_add" placeholder= "Enter Customer Address">
          </div>
          <div class ="cus-tp">
              <p>Tel.no:</p>
              <input type="text" name="c_tp" placeholder= "Enter Customer's tel.no.">
          </div>
           <div class ="cus-name">
              <p>Name:</p>
           ...
           <div class ="cus-NIC">
              <p>NIC:</p>
              <input type="text" name="c_nic" placeholder= "Enter Customer NIC">
          </div>
          <div class ="view">
              <input type ="button" name="view" value="View" onclick="window.location='views/cus_view.php'">
          </div>
          <div class ="submit">
